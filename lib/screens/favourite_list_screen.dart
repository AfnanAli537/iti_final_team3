                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) =>
                            DetailsPage(image: img, images: const []),
                      ),
                    );
                  },
                  child: Container(
...
// import 'package:flutter/material.dart';
// import 'package:flutter_bloc/flutter_bloc.dart';
// import 'package:heba/bloc/favourite_bloc/favourite_bloc.dart';
// import 'package:heba/bloc/favourite_bloc/favourite_event.dart';
// import 'package:heba/bloc/favourite_bloc/favourite_state.dart';
// import 'package:heba/screens/details_screen.dart';
// import 'package:heba/screens/heart_icon.dart';
...
//                         right: 8,
//                         child: LikeButton(
//                           initialIsLiked: true, // لأنه في المفضلة بالفعل
//                           onChanged: (isLiked) {
//                             if (!isLiked) {
//                               // لو لغى الإعجاب، نحذفه من المفضلة
//                               context.read<FavouriteBloc>().add(
//                                 RemoveFavourite(img.url),
//                               );
//                             }
...
//                       builder: (_) => DetailsPage(image: img, images: const []),
//                     ));
//                   },
//                   child: ClipRRect(
//                     borderRadius: BorderRadius.circular(12),
